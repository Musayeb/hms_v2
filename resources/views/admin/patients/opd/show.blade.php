                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($visit as $row)
                                                <tr id="row{{ $row->visit_id }}">
                                                    ...
                                                    <td>
                                                        <a data-toggle="modal" data-target="#print_modal" data-type="visit" data-id="{{$row->visit_id}}"
                                                            class="btn btn-success btn-sm text-white mr-2 print_slip">Print</a>
                                        ...
                                        @foreach ($test as $rows)
                                            <tr id="row">
                                                ...
                                                <td> 
                                                        ...
                                                        <a data-toggle="modal" data-target="#print_modal" data-type="test" data-id="{{$rows->patient_test_id}}"
                                                            class="btn btn-success btn-sm text-white mr-2 print_slip">Print</a>
            ...
            <div class="modal-body pd-20">
                ...
                <form method="post" class="p-3 createform1">
                    ...
                    <div class="form-group">
                        ...
                        <input name="doctor_fess"  readonly class="form-control fees">
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body pd-20">
                ...
                <form method="post" class="p-3 EditVisit">
                    ...
                    <div class="form-group">
                        ...
                        <input name="doctor_fess"  readonly class="form-control fees" id="fee1">
                    </div>
                    <div class="form-group">
                        <label>Description</label>
...
<script>
        $('body').on("click",'.print_slip',function() {
            $.ajax({
                type:'GET',
                url:'{{url("opd/bill/print")}}/'+$(this).attr('data-type')+'/'+$(this).attr('data-id'),
                success:function(data){ 
                   $('.printData').html(data); 
