...
@endsection
@section('title') Surgery @endsection
@section('content')
    <div class="card p-3">
        <div class="btn-list ">
                    ...
                    @foreach ($surgery as $row)
                        <tr id="row{{$row->surgery_id}}">
                            ...
                            @if (!empty(Helper::getpermission('_surgery--edit')))
                                <a data-dep="{{$row->dep_id}}" data-surg="{{$row->surgery_name}}" data-toggle="modal" data-target="#editdept" data-id="{{$row->surgery_id}}" data-fees="{{$row->surgery_fees}}" class="btn btn-info btn-sm text-white mr-2 edit">Edit</a>
                            @endif
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body pd-20">
                    ...
                    <form method="post" id="createform" class="p-3">
                        ...
                        <div class="form-group">
                            <label>Surgery Fees</label>
                           <input type="text" name="surgery_fees" class="form-control" placeholder="Surgery Fees">
                        </div>
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body pd-20">
                    ...
                    <form method="post" id="editform">
                        ...
                        <div class="form-group">
                            <label>Surgery Fees</label>
                           <input type="text" name="surgery_fees" id="surgery_fees" class="form-control" placeholder="Surgery Fees">
                        </div>
                        <div class="modal-footer">
...
@section('jquery')
    ...
    $('body').on('click','.edit',function(){
        ...
        $('#surgery_name').val($(this).attr('data-surg'));   
        $('#surg_id').val($(this).attr('data-id'));     
        $('#surgery_fees').val($(this).attr('data-fees'));           
