...
<script>
    @if (!empty(Helper::getpermission('_dashboard_statistics')))
    var day_data = [<?php echo $chart_data;?> @if(!empty($chart_data))}@endif ];
    new Morris.Bar({
		element: 'morrisBar5',
		data: day_data,
		xkey: 'month',
...
// 3
var day_data = [<?php echo $chart_data2?>}];
    new Morris.Bar({
		element: 'morrisBar7',
		data: day_data,
		xkey: 'month',
    ...
    // 4
    var day_data = [<?php echo $chart_data3?>}];
    new Morris.Bar({
		element: 'morrisBar8',
		data: day_data,
		xkey: 'month',
