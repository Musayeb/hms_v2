...
class Helper{
  ...
  //lab 
    ...
    public static function getCompanyBilltotal($id)
    {
    ...
    public static function getCompanyBillDue($id)
    {
      $total=companyBillInfo1::select(DB::raw('Sum(AMOUNT)as total'))
      ->where('company_bill_info1s.company_bill_id',$id)->get();
      return $total; 
    }
    public static function getSurgeryBillNumber()
    {
      $billNo=patientOperation::select(DB::raw('MAX(operate_no)as max'))->get();
